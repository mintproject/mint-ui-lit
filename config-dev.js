...
window.REACT_APP_MODEL_CATALOG_API = "https://api.models.dev.mint.isi.edu/v1.8.0";
window.REACT_APP_ENSEMBLE_MANAGER_API = "https://dev.ensemble.mint.isi.edu/v1";
...
//Database
window.REACT_APP_GRAPHQL_ENDPOINT = "graphql.dev.mint.isi.edu/v1/graphql";
window.REACT_APP_GRAPHQL_ENABLE_SSL = "True";

//Visualization and Ingestion
window.REACT_APP_VISUALIZATION_URL = "https://dev.viz.mint.isi.edu";
