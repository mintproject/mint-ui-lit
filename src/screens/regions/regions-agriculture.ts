...
export class RegionsAgriculture extends connect(store)(PageViewElement) {
    ...
    protected render() {
        ...
        <p>
        This page is in progress, it will allow you to run workflows to identify agricultural regions of interest.
        ...
        <li><a href="https://raw.githubusercontent.com/mintproject/EthiopiaDemo/master/PIHMtoAgri/map_Landuse.png">Land Use Map</a
            >. Land use map of the Pongo Basin generated by processing PIHM data</li>
        </ul>        
        </p>
        `
    }
