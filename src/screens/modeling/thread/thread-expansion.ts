...
export class ThreadExpansion extends connect(store)(MintThreadPage) {
  ...
  protected _description: TemplateResult = html`General configuration for this
  sub-task. The parameters you set here will be used to filter the models and
  datasets available on next steps.`;
    ...
    return html`
      ...
      >
        ...
        <div @keydown=${this.disableSpace}>
          <div
            style="visibility: ${this.loading && this.open
              ? "visible"
              : "hidden"}"
          ...
          ${this.editMode
            ? html` <div class="footer">
                <wl-button @click="${this.onCancelClicked}" flat inverted
                  >CANCEL</wl-button
                >
                <wl-button
                  type="button"
