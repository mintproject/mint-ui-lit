...
export class MintSummary extends connect(store)(MintThreadPage) {
  ...
  protected render() {
    ...
    let txt =
      "This is a text that should appear in the textbox, shoulnd be editable.";
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Models:
                            <ul>
                                ${Object.keys(this.thread.models!).map(
                                  (modelid: string) => {
                        ...
                        <li>
                            Datasets:
                            <ul>
                                ${Object.keys(this.thread.model_ensembles!).map(
                                  (modelid) => {
                                    let model_ensemble = this.thread
                                    ...
                                    return html`
                                      ...
                                      <ul>
                                        ${model.input_files
                                          ...
                                          .map((io) => {
                                            let bindings =
                                              model_ensemble[io.id!];
                                            let blist = bindings
                                              .map((binding) => {
                                                let ds =
                                                  this.thread.data![binding];
                                                return ds.name;
                                              })
                                              .join(", ");
                            ...
                            <ul>
                                ${Object.keys(this.thread.model_ensembles!).map(
                                  (modelid) => {
                                    ...
                                    let model = this.thread.models![modelid];
                                    return html`
                                      Adjustment Variables for model :
                                      ${model.name}
                                      <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ${Object.keys(
                                  ...
                                  let model = this.thread.models[modelid];
                                  let summary =
                                    this.thread.execution_summary[modelid];
                                  return html`
                                    <li>
                                      The model setup created
                                      ${summary.total_runs} configurations.
                                      ${summary.submitted_runs} model runs were
                                      submitted, out of which
