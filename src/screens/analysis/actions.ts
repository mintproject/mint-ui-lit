...
export type ProblemStatementsAction = ProblemStatementsActionList | ProblemStatementsActionDetails;
...
export type AnalysisAction =  AnalysisActionList | ProblemStatementsAction | ThreadsAction;
