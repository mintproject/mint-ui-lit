...
export interface MessagesActionThreadSubscription
...
// List Scenarios
type ThreadListThunkResult = ThunkAction<
  void,
  RootState,
  undefined,
  MessagesActionThreadList
>;
export const listThreads: ActionCreator<ThreadListThunkResult> =
  () => (dispatch) => {
...
// List Scenarios
type PostListThunkResult = ThunkAction<
  void,
  RootState,
  undefined,
  MessagesActionPostList | MessagesActionThreadSubscription
>;
export const listPosts: ActionCreator<PostListThunkResult> =
...
export type MessagesAction =
  | MessagesActionThreadList
  | MessagesActionPostList
  | MessagesActionThreadSubscription;
