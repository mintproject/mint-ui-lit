    ...
    protected render() {
        ...
        <div class="cltrow">
            ...
            <div class="cltmain" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;padding-left:5px;">
                <wl-title level="4" style="margin: 0px">Configure Models</wl-title>
            </div>
        </div>   

        <p>
        This page is in progress, it will allow you to configure models from the Model Catalog to create expert-configured models for a particular area or region.
        </p>
        `
    }
}
