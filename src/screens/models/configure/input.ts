    ...
    protected render() {
        ...
        <form>
            ...
            <fieldset style="padding-top:0; border:2px solid #d9d9d9; --input-font-size: 12px;">
                ...
                <wl-textfield id="col-${i}-data-catalog-id" type="text" label="MINT Data catalog identifier (optional)"
            ...
            <fieldset style="padding-top:0; border:2px solid #d9d9d9; --input-font-size: 12px;">
                ...
                <wl-textfield id="col-new-data-catalog-id" type="text" label="MINT Data catalog identifier (optional)" value=""></wl-textfield>
            ...
            : ''}
            <wl-textfield id="input-data-catalog-id" type="text" label="MINT Data catalog identifier (optional)" value="${this._input.dataCatalogIdentifier}"
