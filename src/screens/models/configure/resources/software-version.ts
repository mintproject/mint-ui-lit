...
export class ModelCatalogSoftwareVersion extends connect(store)(ModelCatalogResource)<SoftwareVersion> {
    static get styles() {
                ...
                <tr>
                    ...
                    <td>
                        <wl-textfield id="i-version-number" name="Version number"
                                value="${edResource && edResource.hasVersionId ? edResource.hasVersionId[0] : ''}"></wl-textfield>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <wl-select id="i-tag" name="Tag" 
                                value="${edResource && edResource.tag ? edResource.tag : 'latest'}">
                            <option value="">None</option>
                            ${TAG_OPTIONS.map((tag:string) => html`<option value="${tag}">${tag}</option>`)}
                        </wl-select>
                    </td>
                </tr>
    ...
    protected _getResourceFromFullForm () {
        ...
        let inputVersionId : Textfield = this.shadowRoot.getElementById("i-version-number") as Textfield;
