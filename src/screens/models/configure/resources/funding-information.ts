...
export class ModelCatalogFundingInformation extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<FundingInformation, BaseAPI> =
    ModelCatalogApi.myCatalog.fundingInformation;
  ...
  protected _renderForm() {
    ...
    return html` <form>
      ...
      <wl-textarea
        id="f-grant"
        label="Grant"
        value=${edResource && edResource.fundingGrant
          ? edResource.fundingGrant[0]
          : ""}
      >
      </wl-textarea>
    </form>`;
  ...
  protected _getResourceFromForm() {
    ...
    let inputGrant: Textarea = this.shadowRoot.getElementById(
      "f-grant"
    ) as Textarea;
