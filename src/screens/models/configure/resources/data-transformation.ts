...
export class ModelCatalogDataTransformation extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<DataTransformation, BaseAPI> =
    ModelCatalogApi.myCatalog.dataTransformation;
  ...
  protected _renderFullResource(r: DataTransformation) {
    ...
    return html` <table class="details-table">
        ...
        <tr>
          <td>Author</td>
          <td>${this._inputPerson}</td>
        </tr>

        <tr>
          <td>Component Location:</td>
          <td>
            ${r.hasComponentLocation
              ? renderExternalLink(r.hasComponentLocation[0])
              : ""}
          </td>
        </tr>
      ...
      <table class="details-table">
        <tr>
          <td colspan="2" style="padding: 5px 20px;">
            <wl-textfield
              id="dt-label"
              label="Data transformation name"
...
${edResource && edResource.hasUsageNotes
  ...
  protected _renderForm() {
    ...
    return html` <form>
      ...
      <wl-textarea
        ...
        value=${edResource && edResource.hasComponentLocation
  ...
  protected _getResourceFromFullForm() {
    ...
    let inputNotes: Textarea = this.shadowRoot.getElementById(
      "dt-usage-notes"
    ) as Textarea;
