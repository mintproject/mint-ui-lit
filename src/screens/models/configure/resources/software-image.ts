...
export class ModelCatalogSoftwareImage extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<SoftwareImage, BaseAPI> =
    ModelCatalogApi.myCatalog.softwareImage;
    ...
    if (r && r.availableInRegistry && r.availableInRegistry.length > 0) {
      ...
      switch (registry) {
        case "https://hub.docker.com/repository/docker/":
          ...
          url =
            sp.length > 0 ? "https://hub.docker.com/r/" + sp[0] + "/tags" : "";
          break;
        default:
          break;
      }
  ...
  protected _renderForm() {
    ...
    return html` <form>
      ...
      <wl-textfield
        ...
        label="Registry"
        required
        value=${edResource && edResource.availableInRegistry
          ? edResource.availableInRegistry[0]
          : ""}
      >
      </wl-textfield>
    </form>`;
  ...
  protected _getResourceFromForm() {
    ...
    let inputRegistry: Textfield = this.shadowRoot.getElementById(
      "registry"
    ) as Textfield;
    // VALIDATE
