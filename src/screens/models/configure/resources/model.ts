...
export class ModelCatalogModel extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<Model, BaseAPI> =
    ModelCatalogApi.myCatalog.model;
  ...
  protected _renderFullResource(r: Model) {
    ...
    return html` <table class="details-table">
      <tr>
        <td>Category:</td>
      ...
      <tr>
        <td>License:</td>
        <td>${r && r.license ? r.license[0] : ""}</td>
      </tr>

      <tr>
        <td>Citation:</td>
        <td>${r && r.citation ? r.citation[0] : ""}</td>
      </tr>

      <tr>
        <td>Funding:</td>
        <td>${this._inputFunding}</td>
      </tr>

      ${r.theoreticalBasis
        ? html` <tr>
            <td>Theoretical Basis:</td>
            <td>${r.theoreticalBasis ? r.theoreticalBasis[0] : ""}</td>
          </tr>`
        : ""}
      ...
      <tr>
        <td>Purpose:</td>
        <td>${r.hasPurpose ? r.hasPurpose[0] : ""}</td>
      </tr>

      <tr>
        <td>Process:</td>
        <td>${this._inputProcess}</td>
      </tr>

      <tr>
        <td>Input Variable:</td>
        <td>${this._inputVariableInput}</td>
      </tr>

      <tr>
        <td>Output Variable:</td>
        <td>${this._inputVariableOutput}</td>
      </tr>

      <tr>
        <td>Usage notes:</td>
        <td>${r.hasUsageNotes ? r.hasUsageNotes[0] : ""}</td>
      </tr>
      ...
      <tr>
        ...
        <td>${this._inputVisualization}</td>
      </tr>
  ...
  protected _getAdditionalType(m: Model) {
    ...
    if (m && m.type.length >= 2) {
      let ts: string[] = m.type.filter(
        (t: string) =>
          t != "https://w3id.org/okn/o/sdm#Model" &&
          t != "Model" &&
          t != "https://w3id.org/okn/o/sdm#CoupledModel" &&
          t != "CoupledModel"
      );
      if (ts.length > 0) {
        atype = ts[0];
  ...
  private _onTypeChange(e) {
    ...
    if (this._modelType != atype) this._modelType = atype;
  }
  ...
  protected _renderFullForm() {
    ...
    return html`
      ...
      <table class="details-table">
        ...
        <tr>
          ...
          <td>
            <wl-icon
              class="custom-radio"
              @click=${() => {
                this._isCoupledModel = !this._isCoupledModel;
              }}
            >
        ...
        ${this._isCoupledModel
          ? html` <tr>
              <td>Coupled Models:</td>
              <td>${this._inputModel}</td>
            </tr>`
          : ""}
        ...
        <tr>
          ...
          <td>
            ...
            >
              ...
              <option value="https://w3id.org/okn/o/sdm#EmpiricalModel">
                Empirical Model
              </option>
              <option
                value="https://w3id.org/okn/o/sdm#TheoryGuidedEmpiricalModel"
              >
                Theory-guided empirical models
              </option>
              <option value="https://w3id.org/okn/o/sdm#DataAssimilation">
                Data assimilation
              </option>
              <option
                value="https://w3id.org/okn/o/sdm#TheoryAndEmpiricalModel"
              >
                Theory and empirical models
              </option>
              <option value="https://w3id.org/okn/o/sdm#TheoryBasedModel">
                Theory-based model
              </option>
              <!--option value="https://w3id.org/okn/o/sdm#Theory-GuidedModel">Theory Guided Model</option-->
              <option value="https://w3id.org/okn/o/sdm#OtherModel">
                Other
              </option>
            </wl-select>
          </td>
...
${edResource && edResource.description
        ...
        <tr>
          ...
          <td>
            <wl-textfield
              ...
              value="${edResource && edResource.theoreticalBasis
                ? edResource.theoreticalBasis[0]
                : ""}"
            ></wl-textfield>
          </td>
        </tr>
        ...
        <tr>
          <td>License:</td>
          <td>
            <textarea id="i-license" name="License" rows="2">
${edResource && edResource.license ? edResource.license[0] : ""}</textarea
            >
          </td>
        </tr>
        ...
        <tr>
          <td>Citation:</td>
          <td>
            <textarea id="i-citation" name="Citation" rows="2">
${edResource && edResource.citation ? edResource.citation[0] : ""}</textarea
            >
          </td>
        </tr>
...
${edResource && edResource.hasPurpose ? edResource.hasPurpose[0] : ""}</textarea
            >
          </td>
        </tr>
...
${edResource && edResource.hasExample ? edResource.hasExample[0] : ""}</textarea
            >
          </td>
        </tr>
...
${edResource && edResource.hasUsageNotes
        ...
        <tr>
          ...
          <td>
            <wl-textfield
              ...
              value="${edResource && edResource.operatingSystems
                ? edResource.operatingSystems[0]
                : ""}"
            ></wl-textfield>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <wl-textfield
              ...
              type="url"
              value="${edResource && edResource.hasDocumentation
        ...
        <tr>
          ...
          <td>
            <wl-textfield
              ...
              name="Download URL"
              type="url"
              value="${edResource && edResource.hasDownloadURL
        ...
        <tr>
          ...
          <td>
            <wl-textfield
              ...
              name="Installation instructions URL"
              type="url"
  ...
  protected _getResourceFromFullForm() {
    ...
    let inputSO: Textfield = this.shadowRoot.getElementById(
      "i-so"
    ) as Textfield;
    ...
    let inputTheoretical: Textfield = this.shadowRoot.getElementById(
      "i-theoretical"
    ) as Textfield;
  ...
  public clearForm() {
    ...
    let inputCategory: Select = this.shadowRoot.getElementById(
      "i-category"
    ) as Select;
    let inputKeywords: Textfield = this.shadowRoot.getElementById(
      "i-keywords"
