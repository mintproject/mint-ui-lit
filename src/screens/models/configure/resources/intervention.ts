...
export class ModelCatalogIntervention extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<Intervention, BaseAPI> =
    ModelCatalogApi.myCatalog.intervention;
