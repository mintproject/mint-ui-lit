...
export class ModelCatalogPerson extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<Person, BaseAPI> =
    ModelCatalogApi.myCatalog.person;
  ...
  protected _getResourceFromForm() {
    ...
    let inputEmail: Textarea = this.shadowRoot.getElementById(
      "person-email"
    ) as Textarea;
    let inputWeb: Textfield = this.shadowRoot.getElementById(
      "person-web"
    ) as Textfield;
    // VALIDATE
