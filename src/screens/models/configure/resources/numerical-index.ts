...
export class ModelCatalogNumericalIndex extends connect(store)(
  ...
  protected resourceApi: DefaultReduxApi<NumericalIndex, BaseAPI> =
    ModelCatalogApi.myCatalog.numericalIndex;
