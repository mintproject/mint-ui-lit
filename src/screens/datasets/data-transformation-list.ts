...
import { dataTransformationsGet, dataTransformationGet, dataTransformationSetupsGet } from 'model-catalog/actions';
        ...
        return this._loading[this._dtid] ? 
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td>
                        ${dt && dt.hasComponentLocation ? renderExternalLink(dt.hasComponentLocation[0]) : ''}
                    </td>
                </tr>
            </table>
