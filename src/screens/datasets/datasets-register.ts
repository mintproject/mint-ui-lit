    ...
    protected render() {
        ...
        <div class="cltrow">
            ...
            <div class="cltmain" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;padding-left:5px;">
                <wl-title level="4" style="margin: 0px">Add Datasets</wl-title>
            </div>
        </div>   

        <p>
        This page is in progress, it will give you write access to the Data Catalog, where you can add new datasets to the catalog
        </p>
        `
    }
}
