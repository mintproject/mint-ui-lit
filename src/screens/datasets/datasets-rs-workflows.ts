...
export class DatasetsRemoteSensingWorkflows extends connect(store)(
  PageViewElement
) {
  static get styles() {
    return [
  ...
  protected render() {
    let items = [
      {
        label: "Virtual Gauge 1",
        src: "/videos/VirtualGage1.mp4",
        thumbnail: "images/thumbnails/virtual-gauge-1.png",
      },
      {
        label: "Virtual Gauge 2",
        src: "/videos/VirtualGage2.mp4",
        thumbnail: "images/thumbnails/virtual-gauge-2.png",
      },
      {
        label: "Virtual Gauge 3",
        src: "/videos/VirtualGage3.mp4",
        thumbnail: "images/thumbnails/virtual-gauge-3.png",
      },
    ];
    return html` <div class="content">
      <p>
        This page is in progress, it will allow you to run tools that create
        datasets from raw remote sensing data, that can be then used in
        hydrological or other models.
      </p>
