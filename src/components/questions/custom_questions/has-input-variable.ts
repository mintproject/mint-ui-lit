import { DatasetSpecification, DatasetSpecificationFromJSON, ModelCategory, ModelConfigurationSetup, VariablePresentation } from "@mintproject/modelcatalog_client";
                ...
                (s.hasInput||[])
                    ...
                    .forEach((input:DatasetSpecification) => 
                        (input.hasPresentation||[])
                            .map((vp:VariablePresentation) => {
                                console.log(vp, this.variablePresentations)
                                return this.variablePresentations[vp.id];
                            })
