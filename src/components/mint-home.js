...
import mint from '../reducers/mint';
...
let MintHome = class MintHome extends connect(store)(PageViewElement) {
    ...
    _addScenarioDialog() {
        let form = this.shadowRoot.querySelector("#scenarioForm");
        resetForm(form);
    ...
    _onAddScenarioSubmit() {
        ...
        if (formElementsComplete(form, ["scenario_name", "scenario_region", "scenario_from", "scenario_to"])) {
            let scenario_name = form.elements["scenario_name"].value;
            let scenario_region = form.elements["scenario_region"].value;
            let scenario_from = form.elements["scenario_from"].value;
            let scenario_to = form.elements["scenario_to"].value;
            let scenario = {
                name: scenario_name,
    ...
    _selectScenario(e) {
        let selectedScenarioId = e.currentTarget.dataset['index'] + "";
...
], MintHome.prototype, "_regions", void 0);
__decorate([
    property({ type: Object })
], MintHome.prototype, "_list", void 0);
__decorate([
    property({ type: Array })
], MintHome.prototype, "_mapStyles", void 0);
__decorate([
    property({ type: Object })
], MintHome.prototype, "_data", void 0);
MintHome = __decorate([
