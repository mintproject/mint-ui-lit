...
export const renderNotifications = () => {
    ...
    <wl-snackbar id="runNotification" hideDelay="2000" fixed backdrop>
        ...
        <span>Sending runs...</span>
    </wl-snackbar>       
    `;
};
export const renderResponseVariables = (variableid) => {
    return html `
...
export const renderDrivingVariables = (variableid) => {
    return html `
...
export const renderLastUpdateText = (info) => {
