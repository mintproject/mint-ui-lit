...
declare global {
  interface Window {
    ...
    REACT_APP_EXECUTION_ENGINE_TAPIS_TENANT: string;
...
const REACT_APP_EXECUTION_ENGINE_TAPIS_TENANT = window.REACT_APP_EXECUTION_ENGINE_TAPIS_TENANT || "";
...
const MINT_PREFERENCES: MintPreferences = {
  ...
  execution_engine_tapis_tenant: REACT_APP_EXECUTION_ENGINE_TAPIS_TENANT,
  localex: {
