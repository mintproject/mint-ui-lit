...
declare global {
  interface Window {
    ...
    REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS: boolean;
    REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS_TENANT: string | undefined;
...
const REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS = window.REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS || false;
const REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS_TENANT = window.REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS_TENANT || undefined;
...
const MINT_PREFERENCES: MintPreferences = {
  ...
  execution_component_from_tapis: REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS,
  execution_component_from_tapis_tenant: REACT_APP_EXECUTION_COMPONENT_FROM_TAPIS_TENANT,
  localex: {
