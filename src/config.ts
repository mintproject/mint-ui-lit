...
const REACT_APP_DATA_CATALOG_API: string = window.REACT_APP_DATA_CATALOG_API || '';
const REACT_APP_CROMO_API: string = window.REACT_APP_CROMO_API || '';
const REACT_APP_MODEL_CATALOG_API: string = window.REACT_APP_MODEL_CATALOG_API || '';
const REACT_APP_ENSEMBLE_MANAGER_API: string = window.REACT_APP_ENSEMBLE_MANAGER_API || '';
const REACT_APP_EXECUTION_ENGINE: "wings" | "localex" = window.REACT_APP_EXECUTION_ENGINE || 'localex';
const REACT_APP_GOOGLE_MAPS_KEY: string = window.REACT_APP_GOOGLE_MAPS_KEY || '';
...
const REACT_APP_GRAPHQL_ENDPOINT: string = window.REACT_APP_GRAPHQL_ENDPOINT || '';
const REACT_APP_GRAPHQL_ENABLE_SSL: boolean = window.REACT_APP_GRAPHQL_ENABLE_SSL || true;
