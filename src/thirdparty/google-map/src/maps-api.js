...
var callbackPromise = new Promise(function (res, rej) {
    window._resolveGoogleMapsAPI = res;
    window._rejectGoogleMapsAPI = rej;
});
exports.loadGoogleMapsAPI = function (apiKey) { return __awaiter(_this, void 0, void 0, function () {
    var script;
